...
|:---|:---|:---|
| `&` | Ejecuta un comando en segundo plano (*background*). | `sleep 100 &` |
...
2. `ps aux | grep "sleep 500"`
   *(Verás una línea que muestra tu usuario, el PID en la segunda columna, y al final `sleep 500`)*.
