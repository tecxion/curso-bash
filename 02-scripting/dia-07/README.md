...
|:---:|:---|:---|
| `-eq` | Igual que (*Equal*) | `[[ $a -eq $b ]]` |
| `-ne` | Diferente de (*Not Equal*) | `[[ $a -ne $b ]]` |
| `-gt` | Mayor que (*Greater Than*) | `[[ $a -gt $b ]]` |
| `-ge` | Mayor o igual que (*Greater/Equal*) | `[[ $a -ge $b ]]` |
| `-lt` | Menor que (*Less Than*) | `[[ $a -lt $b ]]` |
| `-le` | Menor o igual que (*Less/Equal*) | `[[ $a -le $b ]]` |
...
2. Comando en una sola línea para inicializar variable si está vacía:
   ...
   *(Nota: en Bash existe una forma nativa más corta para esto llamada expansión de parámetros: `echo "${TEXTO:-Sin datos}"`)*.
