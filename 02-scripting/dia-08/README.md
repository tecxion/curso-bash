...
Cuando tienes múltiples opciones que verificar basadas en una sola variable, usar demasiados `elif` puede volver el código ilegible. La estructura `case` (similar al *switch-case* de otros lenguajes) es la solución perfecta.
